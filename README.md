...
- [ ] **Documentation** — Rédiger la doc complète du service (guide utilisateur, concepts, FAQ)
- [ ] **Changelog** — Mettre en place un fichier `CHANGELOG.md` versionné (type [Keep a Changelog](https://keepachangelog.com/fr/1.0.0/))

### Ressources

- [ ] **Guide de démarrage** — Tutoriel pas-à-pas de l'installation à la mise en ligne du premier service
- [ ] **API Reference** — Documentation de l'API REST de contrôle (endpoints, auth, exemples)
- [ ] **Exemples de projets** — Créer un dossier `examples/` avec des cas concrets (portfolio, API, serveur Minecraft, Home Assistant)
- [ ] **Page de statut** — Mettre en place un service de monitoring public (ex. [Upptime](https://upptime.js.org/))

### Entreprise

- [ ] **Page À propos** — Présentation de l'équipe et de la vision du projet
- [ ] **Blog** — Mettre en place un blog technique (annonces, tutoriels, retours d'expérience)
- [ ] **Page Contact** — Formulaire de contact + email de support
- [ ] **CGU & Confidentialité** — Rédiger les Conditions Générales d'Utilisation et la Politique de Confidentialité (RGPD)

### Technique — Client tunnel

- [ ] Développer le binaire client Go (connexion sortante TLS)
- [ ] Reconnexion automatique en cas de coupure
- [ ] Support WireGuard en option
- [ ] Installateur one-liner (`curl -fsSL install.mynodehost.io | sh`)
- [ ] Packages : `.deb`, `.rpm`, `.msi`, `.pkg`

### Technique — Serveur central

- [ ] API REST de gestion des tunnels
- [ ] Port mapper dynamique (attribution/libération de ports)
- [ ] Gestion des sous-domaines (wildcard DNS `*.mynodehost.io`)
- [ ] Certificats SSL automatiques (Let's Encrypt / ACME)
- [ ] Isolation des tunnels entre clients
- [ ] Support TCP + UDP + HTTP/HTTPS

### Technique — Dashboard web

- [ ] Interface de gestion des tunnels actifs
...
- [ ] Responsive mobile (vérification et ajustements)
- [ ] Formulaire d'inscription sur la page Tarifs
- [ ] Page de démonstration interactive
- [ ] SEO — balises meta, Open Graph, sitemap
